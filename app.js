...
const PAYMENT_METHODS = [
  ...
  { id: "cod", icon: "💵" },
  { id: "tpe", icon: "📟" },
  { id: "cih", icon: "🏦", img: "public/img/payments/cih.png" },
  { id: "fellah", icon: "🌾", img: "public/img/payments/fellah.jpg" },
  { id: "cashplus", icon: "💸", img: "public/img/payments/cashplus.jpg" },
  { id: "wafacash", icon: "💰", img: "public/img/payments/wafacash.jpg" },
  { id: "tijari", icon: "🏛", img: "public/img/payments/tijari.jpg" },
  { id: "baridbank", icon: "📮", img: "public/img/payments/baridbank.jpg" },
];
